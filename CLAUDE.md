...
| `/brand`    | Brand book (noindex) · fonte de verdade da marca: 12 seções (01 âncora/missão, 02 dogma, 03 método, 04 marca, 05 modelo, 06 para quem, 07 produtos, 08 voz, 09 pilares, 10 identidade, 11 design system, 12 futuro) |
