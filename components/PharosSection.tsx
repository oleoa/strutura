...
export default function PharosSection() {
  return (
    <section
      id="pharos"
      ...
      <RevealOnScroll delay={0.1}>
        ...
        >
          ...
          <p className="text-base text-ink-soft leading-relaxed">
            O Strutura Pharos é para quem fecha venda dentro do WhatsApp: clínicas
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4">
          <Button asChild size="xl">
            <Link href="https://crm.strutura.ai" target="_blank">
              Ver o Pharos por dentro
            </Link>
          </Button>
          <Button asChild size="xl" variant="outline">
            <Link
              href="https://wa.me/351931135852?text=Ol%C3%A1%2C%20queria%20uma%20demo%20do%20Strutura%20Pharos."
              target="_blank"
            >
              Agendar demo
            </Link>
