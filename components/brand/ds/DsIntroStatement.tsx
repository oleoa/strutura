...
/* Seção 11: abertura do design system + 11.1 Statement.
...
export default function DsIntroStatement() {
  return (
    <Container>
      ...
      >
        <Prose>
          O sistema visual da Strutura para posts, site e materiais. Dois
          climas, <strong>Campo</strong> (a casa) e <strong>Bosque</strong> (o
          acento raro), amarrados por grão, serifa e mostarda envelhecido. Esta seção é a referência de trabalho: quem
