    ...
    <Container>
      ...
      >
        <Prose className="mb-7">
          O frame comercial:{" "}
          <strong>o conteúdo ensina a construir; os produtos vendem o
          pronto.</strong>{" "}
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <Card label="Motor · agora e sempre" title={<><em>Autoridade</em></>}>
            <p>
              Ensinar a construir o sistema que segura vida e negócio
              (Instagram/conteúdo); as ferramentas, IA incluída, entram dentro
              dele. Constrói reputação e{" "}
              <strong>faz tudo o resto valer mais</strong>.
            </p>
          </Card>
          ...
          <Card label="Ativo" title={<><em>SaaS</em></>}>
            <p>
              ...
              (flagship). Produto da casa é{" "}
              <strong>
                pedaço do sistema que o próprio Leonardo roda, produtizado
              </strong>
              . Usado por clientes do mercado <em>e</em> pela própria marca;
              serve de prova.
            </p>
          </Card>
